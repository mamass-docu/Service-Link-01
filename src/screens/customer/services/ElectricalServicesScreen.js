...
const ElectricalServicesScreen = ({ navigation }) => {
  ...
  const electricalServices = [
    {
      ...
      description: 'Professional electrical wiring service with safety compliance and quality materials.',
      included: [
        'Complete wiring inspection',
        'Wire replacement if needed',
        'Circuit testing and safety checks',
        'Professional certification'
      ],
      excluded: [
        'Major structural modifications',
        'Appliance repairs or installation',
    ...
    },
    {
      ...
      image: 'https://d21dfqs8hl0txa.cloudfront.net/service-tasks/main/plug_socket_repair_replacement_installation.webp.1200x630_q85_crop-smart.jpg',
      estimatedTime: '1-2 Hours',
      price: '2500',
      discountedPrice: '2000',
      description: '24/7 emergency electrical repair service for urgent electrical problems.',
      included: [
        'Circuit breaker inspection & repair',
  ...
  const filteredServices = electricalServices.filter(service =>
...
export default ElectricalServicesScreen  ;