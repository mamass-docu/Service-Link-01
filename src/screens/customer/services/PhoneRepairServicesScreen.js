          ...
          <View style={modalStyles.modalContent}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <View style={modalStyles.detailsContainer}>
                ...
                <Text style={styles.warningText}>⚠️ Professional Phone Repair Service</Text>
...
const PhoneRepairServicesScreen = ({ navigation }) => {
  ...
  const phoneServices = [
    {
      id: 1,
      title: 'Screen Repair',
      image: 'https://www.diyfixtool.com/cdn/shop/articles/05qOG26wzVLHG2nlWpelvCF-1..v1683302270_jpg_JPEG_1600x900_71_800x.png?v=1701080915',
      estimatedTime: '1 Hour',
      price: '2500',
      discountedPrice: '1500',
      description: 'Professional screen replacement service with genuine parts and warranty.',
      included: [
        'Screen replacement',
    ...
    },
    {
      ...
      image: 'https://www.batteriesplus.com/4ac40d/globalassets/blog/hero-images/tech/5-reasons-you-should-have-your-phone-fixed-at-batteries-plus.webp',
      estimatedTime: '45 Minutes',
      price: '1500',
      discountedPrice: '1200',
      description: 'Complete battery replacement service with performance optimization.',
      included: [
        'Battery replacement',
    ...
    },
    {
      id: 3,
      title: 'Water Damage',
      image: 'https://www.samsungmobileservicecenterinchennai.com/wp-content/uploads/2022/03/Water-Damaged-Phone-Repair.jpg',
      estimatedTime: '24 Hours',
      price: '1000',
      discountedPrice: '2500',
      description: 'Professional water damage recovery and repair service with thorough cleaning.',
      included: [
        'Moisture removal',
        'Component cleaning',
        'Corrosion treatment',
  ...
  const filteredServices = phoneServices.filter(service =>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Phone Repair Services</Text>
      </View>
...
export default PhoneRepairServicesScreen;