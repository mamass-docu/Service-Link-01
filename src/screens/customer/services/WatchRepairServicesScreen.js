...
const ServiceDetailsModal = ({ visible, service, onClose, navigation }) => {
  ...
  const handleBookNow = () => {
    onClose();
    navigation.navigate('BookService', { service: service });
  };
        ...
        <View style={modalStyles.modalContent}>
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <View style={modalStyles.detailsContainer}>
              ...
              <Text style={styles.warningText}>⚠️ Professional Watch Repair Service</Text>
...
const WatchRepairServicesScreen = ({ navigation }) => {
  const [modalVisible, setModalVisible] = useState(false);
  const [selectedService, setSelectedService] = useState(null);
  const [searchQuery, setSearchQuery] = useState('');

  const watchRepairServices = [
    {
      id: 1,
      ...
      description: 'Professional watch repair and maintenance service. Our expert watchmakers provide comprehensive repair services for all types of watches, from basic battery replacement to complex mechanical repairs.',
      included: [
        'Initial diagnosis',
  ...
  const filteredServices = watchRepairServices.filter(service =>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Watch Repair Services</Text>
      </View>
...
export default WatchRepairServicesScreen;
